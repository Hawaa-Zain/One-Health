  ...
  <body>
    <div class="container-scroller">
     ...
     @include('admin.sidebar')
      ...
      <div class="container" align="center" style="padding: 100px;">
         ...
         @if(session()->has('message'))
          ...
          <div class="alert alert-success">
            <button align="right" type="button" class="close" data-dismiss="alert">
              x
            </button>
      ...
      <form action="{{url('editdotor', $data->id)}}" method="POST" enctype="multipart/form-data">
      ...
      <img width="150" hieght="150" src="doctorimage/{{$data->image}}">
      </div>
